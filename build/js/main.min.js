...
var _initMenu = require("./modules/initMenu");
var _heroSlider = require("./modules/hero-slider");
var _programmsSlider = require("./modules/programms-slider");
var _newsSlider = require("./modules/news-slider");
var _initAccordion = require("./modules/init-accordion");
var _reviewsSlider = require("./modules/reviews-slider");
var _initMap = require("./modules/initMap");
var _customSelect = require("./vendor/custom-select.js");
var _newsCategory = require("./modules/news-category");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    select.init();
    (0, _programmsSlider.initProgrammsSlider)();
    (0, _newsCategory.onChangeCategory)();
...
},{"./modules/form-validate/form":4,"./modules/hero-slider":10,"./modules/init-accordion":11,"./modules/initMap":12,"./modules/initMenu":13,"./modules/modals/init-modals":14,"./modules/news-category":16,"./modules/news-slider":17,"./modules/programms-slider":18,"./modules/reviews-slider":19,"./utils/ios-vh-fix":22,"./vendor/custom-select.js":25}],2:[function(require,module,exports){
"use strict";
...
var slider = document.querySelector('.hero__wrapper');
var heroSlider = function heroSlider() {
  return slider && new Swiper('.hero__wrapper', {
    loop: true,
    slidesPerView: 1,
    spaceBetween: 0,
    pagination: {
...
var mapInit = function mapInit() {
  ...
  var mapIframe = document.querySelector('.contacts__map');
...
var headerMainNav = document.querySelector('.header__nav-list');
var headerToggle = document.querySelector('.header__button-toggle');
var headerToggleIcon = document.querySelector('.header__button-toggle-icon');
var headerNavList = document.querySelectorAll('.header__accordion-list');
var body = document.querySelector('body');
var headerNavContent = document.querySelector('.header__nav-inner-wrapper');
var headerNavElements = document.querySelectorAll('.header__nav-element');
var openMenu = function openMenu() {
  var accordions = new _accordions.Accordions();
  ...
  headerNavList.forEach(function (i) {
...
var initMenuLinks = function initMenuLinks() {
  headerNavElements.forEach(function (item) {
...
},{"../../utils/focus-lock":20,"../../utils/scroll-lock":23}],16:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onChangeCategory = void 0;
var wrapper = document.querySelector('.news__category-list');
var container = document.querySelector('.news__category-wrapper');
var onChangeCategory = function onChangeCategory() {
  if (!container) {
    return;
  }
  var currentCategoryLink = wrapper.querySelector('.news__category-link--current');
...
exports.onChangeCategory = onChangeCategory;
...
var Swiper = window.Swiper;
var slider = document.querySelector('.news__slider');
var initNewsSlider = function initNewsSlider() {
  return slider && new Swiper('.news__slider', {
    navigation: {
...
exports.initProgrammsSlider = void 0;
var Swiper = window.Swiper;
var programmsSlider = document.querySelector('.programms__slider');
var initProgrammsSlider = function initProgrammsSlider() {
  return programmsSlider && new Swiper('.programms__slider', {
    navigation: {
...
exports.initProgrammsSlider = initProgrammsSlider;
...
var initReviewsSlider = function initReviewsSlider() {
  return reviewsSlider && new Swiper('.reviews__slider', {
    navigation: {
